...
contract Voting {
   ...
   function createParty(string memory cn, string memory pn, string memory an, string memory sy, string memory aa) public {
      partyList[partyCount] = party(cn, pn, an, sy, aa);
  ...
  function createUser(string memory _username, string memory _email, string memory _password, string memory _phone, string memory _address, string memory af) public {
      usersList[userCount] = user(_username, _email, _password, _phone, _address, af);
    ...
    function getAadharFinger(uint i) public view returns (string memory) {
        user memory usr = usersList[i];
	return usr.aadhar_finger;
    }
}